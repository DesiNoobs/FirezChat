...
import com.ai.firezchat.Configuration;
...
import com.ai.firezchat.Adapter.UserAdapter;
import com.ai.firezchat.Model.User;
...
public class ProfileFragment extends Fragment {
    ...
    private UserAdapter infoAdapter;
    ...
    private void setupArrayListInfo(User user) {
        listConfig.clear();
        Configuration userNameConfig = new Configuration(USERNAME_LABEL, user.username, R.mipmap.ic_account_box);
        listConfig.add(userNameConfig);

        Configuration emailConfig = new Configuration(EMAIL_LABEL, user.email, R.mipmap.ic_email);
